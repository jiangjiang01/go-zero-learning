...
func GetPermissionDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPermissionDetailReq
		if err := httpx.Parse(r, &req); err != nil {
			errorx.HandleError(w, r, validator.ParseError(err))
			return
		}

		l := logic.NewGetPermissionDetailLogic(r.Context(), svcCtx)
		resp, err := l.GetPermissionDetail(&req)
		if err != nil {
